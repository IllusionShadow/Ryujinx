...
namespace Ryujinx.UI.Common.Configuration
{
    public class ConfigurationState
    {
        ...
        public void LoadDefault()
        {
            ...
            Graphics.ResScale.Value = 2;
            Graphics.ResScaleCustom.Value = 1.0f;
            Graphics.MaxAnisotropy.Value = 16.0f;
            ...
            System.Language.Value = Language.Spanish;
            System.Region.Value = Region.Europe;
            System.TimeZone.Value = "Europe/Madrid";
            System.SystemTimeOffset.Value = -131;
            ...
            Graphics.EnableTextureRecompression.Value = true;
            Graphics.EnableMacroHLE.Value = true;
            Graphics.EnableColorSpacePassthrough.Value = false;
            Graphics.AntiAliasing.Value = AntiAliasing.SmaaUltra;
            Graphics.ScalingFilter.Value = ScalingFilter.Fsr;
            Graphics.ScalingFilterLevel.Value = 10;
            System.EnablePtc.Value = true;
            System.EnableInternetAccess.Value = false;
            System.EnableFsIntegrityChecks.Value = true;
            System.FsGlobalAccessLogMode.Value = 0;
            System.AudioBackend.Value = AudioBackend.SDL2;
            System.AudioVolume.Value = 0.5f;
            ...
            UI.GameDirs.Value = new List<string>() {"F:\\Juegos\\Switch\\Juegos"};
            ...
            UI.WindowStartup.WindowSizeWidth.Value = 1424;
            UI.WindowStartup.WindowSizeHeight.Value = 720;
            UI.WindowStartup.WindowPositionX.Value = 243;
            UI.WindowStartup.WindowPositionY.Value = 177;
